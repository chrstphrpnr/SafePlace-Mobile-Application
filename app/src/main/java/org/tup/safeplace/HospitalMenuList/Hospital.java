...
public class Hospital implements Serializable {
    String hospital_name,hospital_type,hospital_medical_director,hospital_location,hospital_schedule,hospital_contact;

    public Hospital() {
    }


    public Hospital(String hospital_name, String hospital_type, String hospital_medical_director, String hospital_location, String hospital_schedule, String hospital_contact) {
