...
//
//    //User Get User Info
//    public static String get_user_info = API + "get_user_info/";
//
//    //User Change Password
//    public static String change_password = API + "change_password/";
//
//    //User Forgot Password
//    public static String forgot_password = API + "forgot-password/";
//
//    //Hospital Map
//    public static String hospital_map= API + "hospitals_location";
//
//    //Barangay Map
//    public static String barangay_map= API + "barangays_location";
//
//    //Police Map
//    public static String policeStation_map= API + "policestations_location";
//
//
//
//    public static String front_id= API + "verification_frontId";
...
//
//    public static String report_police = API + "police_report";
//    public static String report_barangay = API + "barangay_report";
//
//
    ...
    //Hospital List
    public static String hospital_list_api = "https://safeplacetaguig.com/api/hospitals/";

    //Police Station List
    public static String police_stations_list_api = "https://safeplacetaguig.com/api/police_stations/";
    ...
    //User Authentication REGISTER
    public static String register_user = "https://safeplacetaguig.com/api/register";

    //User Authentication LOGOUT
    public static String logout_user = "https://safeplacetaguig.com/api/logout";
    ...
    //Map Barangay
    public static String barangay_map = "https://safeplacetaguig.com/api/barangays_location";
...
//    public static String update_profile_picture = "update_profile_picture";

    public static String qr_code_login = "https://safeplacetaguig.com/api/qrcode";
    public static String notification = "https://safeplacetaguig.com/api/notification";
    public static String notification_mark_as_read = "https://safeplacetaguig.com/api/notification_read";
    public static String notification_check_unread = "https://safeplacetaguig.com/api/check_unread";
    public static String update_information = "https://safeplacetaguig.com/api/update_information";


    public static String barangay_call_log = "https://safeplacetaguig.com/api/barangay_call_log";
    public static String police_call_log = "https://safeplacetaguig.com/api/police_call_log";

    public static String call_history = "https://safeplacetaguig.com/api/view_call_log";
    ...
    public static String psub_common_crime_year = "https://safeplacetaguig.com/api/psub_common_crime_year";
    public static String psub_common_crime_month = "https://safeplacetaguig.com/api/psub_common_crime_month";

    public static String brgy_common_crime_year = "https://safeplacetaguig.com/api/brgy_common_crime_year";
    public static String brgy_common_crime_month = "https://safeplacetaguig.com/api/brgy_common_crime_month";
